...
test_sentence_6 = ("Kennst du eigentlich meine Verlobte Kim?", "Kennst du eigentlich mein Verlobte Kim?")
...
test_nounphrases = [((2,34), (5,6)), ((1,0), (3,0)), ((4,43),), ((1,0),), ((2,0),), ((5, -1),), ((5,0),), ((5,0), (6,27)), ((9,0),), ((7,27),), ((4,0),)]
...
def sentence_test():
    for i,test in enumerate(test_sentences):
        ...
        assert marking_tool.get_sentence() == test[1] + " ", f"Text {i} doesn't have correct output."
